...
**URL бота:** [https://t.me/itmofimi_pmy_bot](https://t.me/itmofimi_pmy_bot)  
**Username:** `@itmofimi_pmy_bot` (замените на свой реальный username)
...
### Приоритеты для улучшений (по частоте упоминаний)
1. **Добавить онлайн-кнопки** (упомянули 3 пользователя).
2. **Добавить удаление контактов** (2 пользователя).
